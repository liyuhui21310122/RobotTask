...
public class InputFigure extends PortElementFigure {
	...
	protected void paintFigure(Graphics g) {
		...
		g.drawLine(x+10,y+h-40,x+30, y+h-40);
		g.drawLine(x+30,y+h-40,x+30, y+h-20);
		g.drawLine(x+30,y+h-20,x+40, y+h-20);
		g.drawLine(x+40,y+h-20,x+40, y+h-40);
		g.drawLine(x+40,y+h-40,x+50, y+h-40);
		g.drawLine(x+50,y+h-40,x+50, y+h-20);
