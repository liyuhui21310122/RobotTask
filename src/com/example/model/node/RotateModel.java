...
public class RotateModel extends NonContainerModel {
	...
	//******************************************结构体部分********************************
	public RotateModel() {
		super(ConstantResourceFactory.LABEL_ROTATE_MODEL,
				ConstantResourceFactory.ID_ROTATE_MODEL,
				ConstantResourceFactory.SIZE_ROTATE_ELEMENT);
